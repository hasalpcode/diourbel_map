...
import { quartiercibraLayer } from "../sidebar/checkboxes/QuartCibraCheckbox";
...
export function useHoverQuartierCibra(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === quartiercibraLayer  },
    );
