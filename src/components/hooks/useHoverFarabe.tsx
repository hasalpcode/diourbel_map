...
import { forageLayer } from "../sidebar/checkboxes/ForageCheckbox";
import { francoArabeLayer } from "../sidebar/checkboxes/FrancoArabeCheckbox";
...
export function useHoverFarabe(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === francoArabeLayer  },
    );
