...
import { prescolaireLayer } from "../sidebar/checkboxes/PrescolaireCheckbox";
...
export function useHoverPrescolaire(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === prescolaireLayer  },
    );
