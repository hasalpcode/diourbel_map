...
import { ecoleElmLayer } from "../sidebar/checkboxes/EcoleElmCheckbox";
...
export function useHoverEcoleElementaire(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === ecoleElmLayer  },
    );
