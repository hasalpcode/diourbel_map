...
import { ongLayer } from "../sidebar/checkboxes/OngCheckbox";
import { restoLayer } from "../sidebar/checkboxes/RestoCheckbox";
import { robinetLayer } from "../sidebar/checkboxes/RobinetsCheckbox";
import { serviceLayer } from "../sidebar/checkboxes/ServicesCheckbox";
...
export function useHoverService(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === serviceLayer  },
    );
