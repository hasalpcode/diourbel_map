...
import { hotelerieLayer } from "../sidebar/checkboxes/HotelerieCheckbox";
...
export function useHoverHotelerie(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === hotelerieLayer  },
    );
