...
import { grandMosqueLayer } from "../sidebar/checkboxes/GmosqueCheckbox";
import { religionLayer } from "../sidebar/checkboxes/ReligionCheckbox";
...
export function useHoverReligion(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === religionLayer  },
    );
