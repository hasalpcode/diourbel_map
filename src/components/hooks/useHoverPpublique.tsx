...
import { placepLayer } from "../sidebar/checkboxes/PlacePubliqueCheckbox";
...
export function useHoverPpublique(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === placepLayer  },
    );
