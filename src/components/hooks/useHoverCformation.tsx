...
import { cformationLayer } from "../sidebar/checkboxes/CformationCheckbox";
...
export function useHoverCformation(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === cformationLayer },
    );
