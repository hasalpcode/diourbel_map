...
import { s_securiteLayer } from "../sidebar/checkboxes/SsecuriteCheckbox";
...
export function useHoverSsecurite(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === s_securiteLayer  },
    );
