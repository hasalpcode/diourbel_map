...
import { adminLayer } from "../sidebar/checkboxes/AdministrationCheckbox";
import { csocialLayer } from "../sidebar/checkboxes/CentreSocialCheckbox";
import { sportLayer } from "../sidebar/checkboxes/SportCheckbox";
...
export function useHoverSport(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === sportLayer  },
    );
