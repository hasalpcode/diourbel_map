...
import { ifinancierLayer } from "../sidebar/checkboxes/InstFinancierCheckbox";
...
export function useHoverInstFinanciere(checked: boolean) {
  ...
  function handlePointerMove(e: MapBrowserEvent<PointerEvent>) {
    ...
    map.forEachFeatureAtPixel(
      ...
      { hitTolerance: 10, layerFilter: (l) => l === ifinancierLayer  },
    );
