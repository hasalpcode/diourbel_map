...
import { useHoverRobinets } from "../../hooks/useHoverRobinets";
...
export const robinetLayer = new VectorLayer({
  className: "robinets",
...
//485.3
function RobinetsCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(robinetLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverRobinets(checked);
...
export default RobinetsCheckbox;
