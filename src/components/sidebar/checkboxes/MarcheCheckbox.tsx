...
import { useHoverMarche } from "../../hooks/useHoverMarche";
...
export const marcheLayer = new VectorLayer({
  className: "marche",
...
//485.3
function MarcheCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(marcheLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverMarche(checked);
