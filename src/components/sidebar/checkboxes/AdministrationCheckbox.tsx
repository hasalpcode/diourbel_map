...
import { useHoverAdministrateur } from "../../hooks/useHoverAdministrateur";
...
export const adminLayer = new VectorLayer({
...
//485.3
function AdministrationCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(adminLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverAdministrateur(checked);
...
export default AdministrationCheckbox;
