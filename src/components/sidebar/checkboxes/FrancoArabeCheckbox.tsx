...
import { useHoverFarabe } from "../../hooks/useHoverFarabe";
...
export const airportSource = new VectorSource({
  url: "/francoArabe.json",
  format: new GeoJSON(),
});

export const francoArabeLayer = new VectorLayer({
  className: "francoArabe",
...
//485.3
function FrancoArabeCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(francoArabeLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverFarabe(checked);
...
export default FrancoArabeCheckbox;
