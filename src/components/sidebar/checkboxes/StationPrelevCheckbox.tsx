...
import { useHoverSprelev } from "../../hooks/useHoverSprelev";
...
export const airportSource = new VectorSource({
  url: "/StationPrelevement.json",
  format: new GeoJSON(),
});

export const sPrelevLayer = new VectorLayer({
  className: "stationPrelevement",
...
//485.3
function StationPrelevCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(sPrelevLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverSprelev(checked);
...
export default StationPrelevCheckbox;
