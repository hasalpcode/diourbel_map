...
import { useHoverHotelerie } from "../../hooks/useHoverHotelerie";
import { useHoverInstFinanciere } from "../../hooks/useHoverIfinance";
...
export const airportSource = new VectorSource({
  url: "/instFinanciere.json",
  format: new GeoJSON(),
});

export const ifinancierLayer = new VectorLayer({
  className: "ifinanciere",
...
//485.3
function InstFinancierCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(ifinancierLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverInstFinanciere(checked);
...
export default InstFinancierCheckbox;
