...
export const hotelerieLayer = new VectorLayer({
  className: "hotel",
...
//485.3
function HotelerieCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(hotelerieLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverHotelerie(checked);
...
export default HotelerieCheckbox;
