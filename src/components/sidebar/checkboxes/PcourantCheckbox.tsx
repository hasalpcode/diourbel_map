...
import { useHoverPcourant } from "../../hooks/useHoverPcourant";
...
export const airportSource = new VectorSource({
  url: "/postCourant.json",
  format: new GeoJSON(),
});

export const pcourantLayer = new VectorLayer({
  className: "postCourant",
...
//485.3
function PcourantCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(pcourantLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverPcourant(checked);
...
export default PcourantCheckbox;
