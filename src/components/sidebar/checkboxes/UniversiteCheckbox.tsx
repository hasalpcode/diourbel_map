...
import { useHoverUniv } from "../../hooks/useHoverUniv";
...
export const univLayer = new VectorLayer({
...
//485.3
function UnivCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(univLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverUniv(checked);
