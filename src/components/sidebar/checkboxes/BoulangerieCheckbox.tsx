...
import { useHoverBoulangerie } from "../../hooks/useHoverBoulangerie";
...
export const airportSource = new VectorSource({
  url: "/boulangerie.json",
  format: new GeoJSON(),
});

export const boulangerieLayer = new VectorLayer({
  className: "boulangerie",
...
//485.3
function BoulangerieCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(boulangerieLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverBoulangerie(checked);
...
export default BoulangerieCheckbox;
