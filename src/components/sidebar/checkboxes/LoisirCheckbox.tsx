...
import { useHoverLoisir } from "../../hooks/useHoverLoisir";
...
export const loisirLayer = new VectorLayer({
  className: "loisir",
...
//485.3
function LoisirCheckbox() {
  const [checked, setChecked] = useState(false);

  useLayer(loisirLayer, checked);
  useLayer(clusterLayer, checked);
  useHoverLoisir(checked);
